...
Window {
    ...
    contentChildren: TextEdit {
        ...
        text: '      QueMusic 使用 Apache License 2.0授权开源
                                 Apache License
   ...
   4. Redistribution. You may reproduce and distribute copies of theWork or Derivative Works there of in any medium, with or withoutmodifications, and in Source or Object form, provided that Youmeet the following conditions:
